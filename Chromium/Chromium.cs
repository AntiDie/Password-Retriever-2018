...
namespace xoxoxo.Chromium
{
    internal abstract class ChromiumBase
    {
        ...
        protected string ActualDataPath { private get; set; } = string.Empty;

        protected string RegistryPath { private get; set; } = string.Empty;

        private string CopiedDataPath { get; set; } = string.Empty;
